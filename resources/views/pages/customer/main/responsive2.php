        ...
        <div class="row">
            <div style="" class="col-sm-9 ">
                ...
                <div class="sticky ">
                    ...
                    <div class="row mt-3" id="1" style="" >
                        <div class="row ">
                            <div  class="col-sm-12" >
                            <h4 style="margin-left:30px;margin-top:30px;">POPULAR</h4>
                            </div>
                        </div>
                        ...
                        <div  class="col-sm-6 d-flex justify-content-center " >
                            ...
                            <div class="col-9">
                                <div style="margin-top:10px;">
                                    ...
                                    <i style="font-size: 12px;">ALL-NEW Mas Meaty, Smokey-Wok Sarap fried rice, Smokey-Wok Sarap fried rice </i>
                                    <div  class="absolute">P 173</div>
                                </div>
                            </div>
                                <div class="col-3 relative" style="background-image: url('{{ asset('slick/img/2pc.jpg')}}');background-size: contain;background-size: cover;">
                    ...
                    <div class="row mt-3" id="2" style="" >
                        <div class="row ">
                            <div  class="col-sm-12" >
                            <h4 style="margin-left:30px;margin-top:30px;" id="">FAMILY MEALS</h4>
                            </div>
                        </div>
