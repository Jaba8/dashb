...
<nav class="main-header  navbar-expand navbar-white navbar-light " style="padding: 5px !important;z-index: 1">
  <!-- Left navbar links -->
     <div class="row mx-0">
          ...
          <div class="col-sm-5">
            <h4 style="font-weight: bold" class="mt-1"> Order List</h4>
          </div>
                ...
                <table class="table table-head-fixed text-nowrap table-striped table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">{{$order ->s_name }}</td>
                      <td class="align-middle">{{$order ->c_lname}}</td>
                      <td class="align-middle">{{$order ->d_lname}}</td>
