...
<nav class="main-header  navbar-expand navbar-white navbar-light " style="padding: 5px !important;z-index: 1">
  <!-- Left navbar links -->
     <div class="row mx-0">
          ...
          <div class="col-sm-5">
            <h4 style="font-weight: bold" class="mt-1"> Product List</h4>
          </div>
                             ...
                             <form action="/product" method="POST" enctype="multipart/form-data">
                               ...
                               <div class="form-row">
                                  ...
                                  <div class="form-group col-md-6">
                                    ...
                                    {{-- <select name="name[]" id="name" multiple  class="form-control cat_test ">
                                    </select> --}}
                              ...
                              <div class="form-row">
                                <div class="form-group col-md-6">
                                  ...
                                  <select class="form-select" aria-label="Default select example" name="category_id" id="category_id" required>
                                    <option class="opt1" value="" disabled selected hidden>Select Product Category</option>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <img src="uploads/product/{{$product ->profile_image}}" alt="" style="width: 100px;
                        height: 50px;">
                      </td>
                      <td class="align-middle">{{$product ->s_name }}</td>
                      <td class="align-middle">{{$product ->c_name }}</td>
                              ...
                              <div class="modal-content">
                                  <div class="modal-header">
                                      ...
                                      <div class="modal-body">
                                                      <form action="" method="POST" enctype="multipart/form-data" id="formid">
                                                        ...
                                                        <div class="form-row">
                                                          <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" name="product_name2" id="product_name2" placeholder="Product Name" required>
                                                          </div>
                                                      ...
                                                      <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                          <label for="category_id2">Product Category</label>
                      ...
                      <td style="display:none;">{{$product ->store_id}}</td>
                      <td style="display:none;">{{$product ->category_id}}</td>
                      <td style="display:none;">{{$product ->status}}</td>
                      <td style="display:none;">{{$product ->profile_image}}</td>
...
<script>
  $(document).ready(function () {
      ...
      $('.editbtn').on('click', function () {
          ...
          let updateroute = "/product/"+data[0].toString();
          $("#formid").attr("action", updateroute);

          $('#product_name2').val(data[4]);
          ...
          let prof_img_val = "uploads/product/"+data[12].toString();
