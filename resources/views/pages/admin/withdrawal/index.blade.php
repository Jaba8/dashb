...
<nav class="main-header  navbar-expand navbar-white navbar-light " style="padding: 5px !important;z-index: 1">
  <!-- Left navbar links -->
     <div class="row mx-0">
          ...
          <div class="col-sm-5">
            <h4 style="font-weight: bold" class="mt-1"> Withdrawal List</h4>
          </div>
                ...
                <table class="table table-head-fixed text-nowrap table-striped table-hover">
                  ...
                  <tbody>
                    ...
                    <td class="align-middle">
                      ...
                      <td class="align-middle">
                        @if($withdrawal->status == 0)
                            <form style="display: inline;" action="withdrawal/{{$withdrawal ->id}}"   method="POST" enctype="multipart/form-data" id="formid">
                                @csrf
                                @method('PUT')
                                <input type="submit" class="btn btn-primary" value="Approved">
                            </form>
                            <form style="display: inline;" action="decline-withdrawal/{{$withdrawal ->id}}"   method="POST" enctype="multipart/form-data" id="formid">
                                @csrf
                                @method('PUT')
