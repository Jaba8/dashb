...
<script>
  $(document).ready(function () {
      ...
      $('.editbtn').on('click', function () {
          ...
          console.log(data);
          let updateroute = "/store/"+data[0].toString();
