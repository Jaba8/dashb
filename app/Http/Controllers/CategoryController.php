...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
            ...
            return redirect('/category')->with('success','Category Information Successfully Added!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $category->save();
        return redirect('/category')->with('success','Category Information Successfully Updated!');
